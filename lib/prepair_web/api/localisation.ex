defmodule PrepairWeb.Api.Localisation do
  @locales Gettext.known_locales(PrepairWeb.Gettext)

  def set_api_localisation(conn, _opts) do
    locale = locale_from_headers(conn)
    if is_binary(locale), do: Gettext.put_locale(locale)
    conn
  end
